...
export default class QuestionAnswer extends React.Component {
  ...
  render() {
    return (
      <View style={[styles.answerContainer , {backgroundColor : this.props.answerColor}]} >
        <Text style={[styles.answerBody , {color: this.props.answerTextColor}]}> {this.props.answerBody} </Text>
      </View>
    );
  }
}
